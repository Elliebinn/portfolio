...
export const resume: ResumeData = {
      ...
      projects: [
        {
          ...
          bullets: [
            ...
            '약 500여 개 전략의 탐색 구조를 유니버스 × 태그 분류로 재편. 탭 3개로 분산된 분석 흐름을 성과요약 + 매매탐색 2페이지로 통합',
            '화면 구현 중 샤프지수 산식 오류 등 지표 품질 문제를 직접 감지하여 **10개 지표 산식을 표준화**하고 단일 glossary로 통합',
            '목업 시안을 슬랙으로 공유하는 피드백 사이클을 구축하여 1~2일 내 반영. UX/UI 전문가 평가 56% 개선',
          ],
        },
        {
      ...
      projects: [
        {
          ...
          description:
            'KOSCOM 로보어드바이저 테스트베드에서 AI 투자 알고리즘의 운용 능력을 심사받는 과정. 참여 신청부터 사전심사·본심사·사후운용심사까지 전 과정을 PM으로 주도.',
          bullets: [
        ...
        },
        {
          ...
          bullets: [
            '알파로보 7년 트랙레코드(+42.82% vs KOSPI +10.85%)를 기반으로 한 **S&P500 AI 펀드 2종**(성장 포커스 30, 배당 포커스 30)의 판매사 대상 **투자 전략 제안서를 직접 작성**. 현재 상장·운용 중',
            '외부 자산운용사 컨설팅 **소통 담당**으로 참여. 고객사 피드백에서 XAI(종목 선정 근거 설명) 필요성을 파악하여 제안·반영. **다올자산운용 MOU 체결**',
          ],
        },
        {
          title: 'AI 운용지원 시스템 기획',
          bullets: [
            '직접 4개 AI 펀드의 일일 운용을 수행하며 3개 시스템 분산·수동 파일 업로드 등 병목을 체감. **AS-IS/TO-BE 아키텍처를 도식화**하고 스프린트 단위 요건정의서를 직접 작성하여 통합 모니터링 시스템 기획',
  ...
  linkedin: {
    ...
    achievements: [
      ...
      '전략 모니터링·성과 분석 대시보드 — 약 500여 개 전략 IA 재설계, 10개 지표 표준화, 10+ 페이지 전환',
