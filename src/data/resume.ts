...
export type ResumeProject = {
  title: string;
  /** Optional period for the project (e.g. "2026.01 - 현재") */
  period?: string;
...
export const resume: ResumeData = {
  ...
  summary: {
    ...
    body:
      '에셋플러스자산운용에서 AI 공모펀드 운용지원 시스템을 기획하여 매매·운용시간 **83% 단축**을 이끌었고, **38개 AI 투자 알고리즘**의 로보어드바이저 심사를 **PM으로 주도**했습니다. 현재는 퀀트 리서치팀이 매일 사용하는 전략 모니터링·운용 관리 대시보드를 처음부터 다시 설계하고 있으며, 화면 설계부터 AI 코딩 도구를 활용한 **구현·품질 검증까지 직접 책임지고** 수행합니다. 사이드 프로젝트로 AI 멀티에이전트 주식 분석 서비스를 1인으로 기획·개발하고 있습니다.',
  },
  jobs: [
    {
      company: '알파브릿지',
